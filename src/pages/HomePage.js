  ...
  return (
    <div className="bg-slate-800 flex flex-wrap justify-center items-center h-screen">
        <Link to={`/projects`} className="w-full sm:w-1/2 md:w-1/3 lg:w-1/3 p-4">
           <div className="bg-slate-400 rounded-3xl shadow-xl shadow-cyan-300/80 hover:shadow-slate-50 hover:rounded-full transition-all duration-300 ease-in-out relative">
