                  ...
                  <div className="mt-2">
                    ...
                    {user.gitHub && (
                      <div className="ml-12 mb-2 mt-2 flex items-center">
                        ...
                        <NavLink className="mx-6" to={user.gitHub}>GitHub</NavLink>
                    ...
                    {user.linkedIn && (
                      <div className="ml-12 mb-2 flex items-center">
                        ...
                        <NavLink className="mx-6" to={user.linkedIn}>LinkedIn</NavLink>
                      </div>
                    )}
                    ...
                    {user.twitter && (
                      <div className="ml-12  mb-2 flex items-center">
                        ...
                        <NavLink className="mx-6" to={user.twitter}>Twitter</NavLink>
                      </div>
                    )}
                    ...
                    {user.instagram && (
                      <div className="ml-12  mb-2 flex items-center">
                        ...
                        <NavLink className="mx-6" to={user.instagram}>instagram</NavLink>
                      </div>
                    )}

                    {counts[user._id] && (
                      <>
                        <p className="text-slate-400 mt-5">Active Projects: {counts[user._id].projects}</p>
