          ...
          <form className="mb-4" onSubmit={handleSubmit}>
            ...
            {contribution.owner ? (
              <div>
                ...
                <p>Created at: {new Date(contribution.createdAt).toLocaleDateString()}</p>
                ...
                <input
                 ...
                 message="message"
                 value={message}
                 placeholder= {!messageSent ? `Send a message to ${contribution.owner.name}` : "message sent succesfully"}
