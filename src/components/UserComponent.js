...
function UserComponent(props) {
  ...
  return (
    <div className="backdrop-blur-sm border rounded-3xl grid justify-items-center text-white  hover:shadow-white hover-shadow-xl shadow-lg shadow-cyan-400  p-4">
      <img
            ...
            user.reviews.map((review, index) => {
              return (
                <div key={index}>
                  ...
                  <p className="italic font-light pt-2">
